...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category, pledges.amount FROM pledges JOIN users ON users.id = pledges.user_id JOIN projects ON pledges.project_id = projects.id WHERE projects.category = 'music';"
end
